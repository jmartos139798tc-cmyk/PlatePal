            ...
            <div class="w-full px-6 py-8 sm:px-10 sm:py-10 lg:max-w-[590px] lg:px-14 lg:py-14 xl:px-20">
                ...
                <div class="mt-14 max-w-[360px] sm:mt-16 lg:mt-24">
                    <h1 class="text-[30px] font-extrabold leading-tight text-[#1F2937] sm:text-[33px]">
                        Welcome Back, Caterer
                    </h1>
                    <p class="mt-2 text-[15px] leading-7 text-[#6B7280]">
                        Sign in to manage your menu, bookings, and connect with clients
                    </p>
                    ...
                    <form method="POST" action="{{ route('caterer.login.post') }}" class="mt-7 space-y-4">
                        @csrf
                        ...
                        <button
                            type="submit"
                            class="mt-1 inline-flex w-full items-center justify-center rounded-[7px] bg-[#111827] px-5 py-[10px] text-[14px] font-semibold text-white transition-colors hover:bg-[#1F2937] focus:outline-none focus:ring-2 focus:ring-[#111827] focus:ring-offset-2"
                        >
                            Sign In
                        </button>
                    </form>
        ...
        <aside class="flex w-full bg-[linear-gradient(135deg,#111827_0%,#374151_100%)] text-white lg:min-h-screen lg:w-1/2 lg:items-center">
            <div class="w-full px-8 py-10 sm:px-10 lg:max-w-[590px] lg:px-16 lg:py-14 xl:px-20">
                ...
                <p class="mt-4 max-w-[380px] text-[15px] leading-8 text-white/95">
                    Connect with clients in Tagum City. Manage your bookings, showcase your specialties, and expand your reach.
                </p>
                ...
                <div class="mt-8 space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-[14px] leading-7 text-white/90">Manage bookings and availability in real-time</p>
                    </div>
                    <div class="flex items-start gap-3">
                        <span class="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/20 text-[9px] text-white">
                            <i class="fas fa-check"></i>
                        </span>
                        <p class="text-[14px] leading-7 text-white/90">Showcase your menu and specialties</p>
                    </div>
                    <div class="flex items-start gap-3">
                        <span class="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/20 text-[9px] text-white">
                            <i class="fas fa-check"></i>
                        </span>
                        <p class="text-[14px] leading-7 text-white/90">Reach more clients in your area</p>
                    </div>
                </div>
            </div>
        </aside>
